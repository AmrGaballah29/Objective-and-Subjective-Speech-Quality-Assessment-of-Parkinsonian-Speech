...
function [ceps,freqresp,fb,fbrecon,freqrecon] = ...
		mfcc(input, samplingRate, frameRate)
%This function calculates 13 MFCC featues for a speech signal.
%Inputs are input: the raw speech signal, samplingrate : 16 kHz,
%framerate,fcoefs: ERB filterbank.
%The output is 13 features vector where 13 is the number of MFCC features.
...
%triangleHeight = 1;   % For normalized response
